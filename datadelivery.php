...
<script type="text/javascript" src="assets/js/auth.js "></script>
    ...
    <script>
        ...
        let url = serverHosting + "/deliveryIML/list_status/PM1Roll"
        if(getStatus){
            url=serverHosting + "/deliveryIML/list_status/PM1Roll/"+getStatus
            ...
            if(getStatus=="parkirdco"){
                url=serverHosting + "/deliveryIML/parkirdco/PM1Roll"
            }
