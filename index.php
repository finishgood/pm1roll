                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group row" x-show="(action=='selesai')">
                                                            <label class="col-sm-3 col-form-label">Qty Pallet</label>
                                                            <div class="col-sm-6">
                                                                <input type="number" class="form-control" min="0" x-model="txtQtyPallet" />
                                                            </div>
                                                        </div>
    ...
    function dashboardView() {
            return {
                ...
                async executeBarcode(){
                    ...
                    try{
                            ...
                            body: JSON.stringify({ 
                                ...
                                QtyPallet: parseInt(this.txtQtyPallet), 
                ...
                async getData(){
                    ...
                    let url3 = serverHosting+"/deliveryIML/parkirdco/PM1Roll"
